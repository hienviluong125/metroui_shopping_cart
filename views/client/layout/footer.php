...
<div class="bg-custom-blue mt-10">
    <div class="container pb-5">
        <div class="grid">
            <div class="row">
                <div class="custom-footer cell-3 pr-5 fg-white">
                    <h5 class="text-medium mb-5  fg-white mt-5">Liên hệ</h5>
                    <p class="text-secondary">Công ty cung cấp linh kiện máy tính thiết bị
                        227 Nguyen Van Cu Street, 5 District, Ho Chi Minh City
                        P: (+84) 666 999 333 (Mr WeeDev)
                        E: WeeDev@blur.it.vn
                        WeeDev.blur.com.vn
                        MST: 0031247
                    </p>
                ...
                <div class="cell-3 pr-5">
                    ...
                    <span class="mif-facebook2 mif-3x fg-white"></span>
                    &ensp;
                    <span class="mif-twitter mif-3x fg-white"></span>
                    &ensp;
                    <span class="mif-github mif-3x fg-white"></span>
                    &ensp;
                    <span class="mif-google-plus mif-3x fg-white"></span>
...
<div class="copy-right fg-white">
    <div class="container">
        <div class="float-left mt-2 mb-2">
            Copy right @2018 by WeeDev.blur.it
        </div>
        <div class="float-right mt-2 mb-2">
            Design by NotMieNamu by 🙌 and 🧠 
        </div>
    </div>
</div>
