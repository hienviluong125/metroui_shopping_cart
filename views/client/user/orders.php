...
<div class="container main-container pt-0 my-cart">
    <div class="grid">
        <div class="row">
            <h1 class="ml-10 mt-3 mb-5 ">Lịch sử đơn hàng</h1>
            <div class="cell-12">
                <div class="row">
                ...
                <div class="row">
                    <?php foreach($data['orders'] as $o){?>
                        ...
                        <div class="text-center cell-2">
                            ...
                            <?php if($o['status']) {?>
                                    <p class="bg-green fg-white p-1 pl-2 pr-2 border-radius-4" >
                                        Đã giao hàng
                                    </p>
                                <?php }else{ ?>
                                    <p class="bg-red fg-white p-1  pl-2 pr-2 border-radius-4" >
                                        Đang vận chuyển
                                    </p>
                                <?php } ?>
                            </div>
